...
sed -i -e 's/MONGO_DNSNAME/mongodb.roboshop.internal/' ${APPUSER_DIR}/${COMPONENT}-main/systemd.service
mv ${APPUSER_DIR}/${COMPONENT}-main/systemd.service  /etc/systemd/system/${COMPONENT}.service
stat $?
